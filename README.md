...
En la documentación del proyecto ([wiki TFG](https://github.com/jogugil/MyRC/wiki)) se comenta tanto las funciones y API de los diferentes módulos del framework (apartado 6 de la documentación) como la teoría que soporta cada módulo.
